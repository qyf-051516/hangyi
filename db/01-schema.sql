...
('ADMIN', '系统管理员', '系统超级管理员，拥有全部权限'),
('BOSS', '站领导', '机场站领导，可查看所有排班和统计数据'),
('TEAM_LEADER', '班组长', '班组负责人，可管理本班组排班'),
...
('MORNING',  '早班',   '08:00', '16:00', 'DAY',     '#67C23A'),
('EVENING',  '晚班',   '16:00', '00:00', 'DAY',     '#E6A23C'),
('NIGHT',    '夜班',   '00:00', '08:00', 'NIGHT',   '#F56C6C'),
('STANDBY',  '备勤',   '08:00', '08:00', 'STANDBY', '#909399'),
('REST',     '休息',   '00:00', '00:00', 'REST',    '#DCDFE6');
