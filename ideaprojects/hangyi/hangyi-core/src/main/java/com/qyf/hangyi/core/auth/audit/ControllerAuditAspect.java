package com.qyf.hangyi.core.auth.audit;

import com.qyf.hangyi.common.result.R;
import com.qyf.hangyi.core.auth.audit.service.OperationLogService;
...
public class ControllerAuditAspect {
    ...
    public ControllerAuditAspect(OperationLogService operationLogService) {
        this.operationLogService = operationLogService;
    }

    @Around("execution(public * com.qyf.hangyi.core..controller..*(..))")
    public Object audit(ProceedingJoinPoint joinPoint) throws Throwable {
        Object result = joinPoint.proceed();
        HttpServletRequest request = currentRequest();
        if (request == null || !MUTATING_METHODS.contains(request.getMethod())
