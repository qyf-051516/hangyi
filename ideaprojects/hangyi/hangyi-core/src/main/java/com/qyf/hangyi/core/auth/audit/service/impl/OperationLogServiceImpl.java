package com.qyf.hangyi.core.auth.audit.service.impl;
    ...
    public String exportCsv(String action, String startDate, String endDate) {
        ...
        for (OperationLog l : logs) {
            sj.add(String.format("%s,%s,%s,%s,%s",
                csvCell(l.getCreatedAt()), csvCell(l.getAction()), csvCell(l.getDetail()),
                csvCell(l.getTargetType()), csvCell(l.getTargetId())));
        }
        return sj.toString();
    }
